...
public class TodoManager {
    ...
    public boolean update(long id, model.TodoStatus status) {
        ...
        try {
            try {
                return Todo.builder()
                        ...
                        .status(model.TodoStatus.valueOf(resultSet.getString(4)))
//                        .user()
    ...
    public List<Todo> getAllTodosByUserAndStatus(long user_id, model.TodoStatus status) {
        List<Todo> todos = new ArrayList<>();
